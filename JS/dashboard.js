document.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                const data = {
                    charts: {
                        ...
                        governorates: { labels: ['الشرقية', 'دمياط', 'السويس', 'بورسعيد'], values: [8, 5, 6, 4] }
                    },
                    projects: [
                        { id: 1, name: 'تطوير وتوسعة طريق العريش', category: 'طرق', progress: 75 },
                        { id: 2, name: 'إنشاء 500 وحدة إسكان', category: 'اسكان اجتماعي', progress: 30 },
                        { id: 3, name: 'تأهيل محطة مياه دمياط', category: 'مياه', progress: 95 }
                    ]
                };
                resolve(data);
            }, 1500);
    ...
    function renderCharts(chartData) {
        ...
        chart2Container.innerHTML = '<canvas id="projectsByGovernorateChart"></canvas>';
