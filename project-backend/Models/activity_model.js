...
const activitySchema = new mongoose.Schema(
  {
    ...
    // ### بداية: الحقول الجديدة التي تمت إضافتها ###
    ...
    governorate: {
        ...
        enum: {
            values: ['شمال سيناء', 'جنوب سيناء', 'بورسعيد', 'الاسماعيلية', 'السويس', 'الشرقية', 'دمياط'],
    ...
    fundingType: {
        // نوع التمويل
        type: String,
        required: [true, "نوع التمويل مطلوب."],
        enum: {
            values: ['خطة استثمارية', 'تمويل الغير'],
            message: 'نوع التمويل يجب أن يكون إما "خطة استثمارية" أو "تمويل الغير".'
        }
    },
    projectCategory: {
        // فئة المشروع
        type: String,
        required: [true, "فئة المشروع مطلوبة."],
        enum: {
            values: [
                'طرق', 'كهرباء', 'مياه', 'صرف صحي', 'اسكان بدوي', 'اسكان اجتماعي', 
                'خدمات', 'تنمية متكاملة', 'حضانات', 'مجازر', 'تأهيل مباني حكومية', 'آخر'
            ],
